...
//        window?.rootViewController = UINavigationController.init(rootViewController: friendsController)
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "FbMessenger", withExtension: "momd")!
